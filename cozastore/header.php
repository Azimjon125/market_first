				...
				<div class="content-topbar flex-sb-m h-full container">
					...
					<div class="right-top-bar flex-w h-full">
						...
						if ($_SESSION["user"]=="Admin") {
							?><a href="dec.php" class="flex-c-m trans-04 p-lr-25">
							Admin (logout)
						</a>
...
{
	echo "<a href='dec.php' class='flex-c-m trans-04 p-lr-25'>".$_SESSION["user"]."
						 (logout)</a>";
}
						}
						else
						echo "<a href='kirish.php' class='flex-c-m trans-04 p-lr-25'>
							My Account
						</a>";
						?>
					</div>
...
?>
						<div class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 icon-header-noti js-show-cart" data-notify="<?php echo $i;?>">
