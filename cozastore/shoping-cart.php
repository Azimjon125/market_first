...
<tr class="table_row">
									...
									<td class="column-5">$ <?php $a= $chiq["num"]; 
									$b=$chiq["price"]; 
									 echo $c=$a*$b;
									 ...
									 ?></td>
									 <td>
									 	<a href="?del=<?php echo $chiq["id"];?>" class="btn btn-danger">DEL</a>
									 </td>
								</tr>
...
?>
				...
				<div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
					<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
						...
						<button onclick="my()" class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer">
							Proceed to Checkout
						</button>
					</div>
				</div>
